    ...
    private var privacyCard: some View {
        card {
            Label("الخصوصية", systemImage: "hand.raised")
                .font(.headline)
            Text("قائمة لقطات الشاشة لا تنشئ نسخاً إضافية من الصور: يتم عرض الأصول الموجودة في Photos لمدة 30 دقيقة فقط. محفوظات النصوص والاقتراحات تُحفظ محلياً داخل مساحة الكيبورد على جهازك.")
                .font(.footnote)
                .foregroundStyle(.secondary)
        }
    }
